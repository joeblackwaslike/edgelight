...
slug: /
title: edgelite
description: edgedb meets sqlite
---
...
Replace this with your one-sentence value proposition. What does edgelite do that nothing else does?
:::
...
**The solution:** edgelite solves this with a clean, TypeScript-first API. One import, zero configuration, full type safety.
...
**[Get Started →](./getting-started)** · **[API Reference →](./api)** · **[GitHub →](https://github.com/joeblackwaslike/edgelite)**

---

*Built with TypeScript. MIT License. Made by [Joe Black](https://github.com/joeblackwaslike).*
